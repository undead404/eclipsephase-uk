...
| [Патрон](../04/28-traits.md#Патрон)                                 |     6     | Вас підтримує впливова особа. Одна безплатна значна послуга за сюжетну лінію.                                                                                                                                       |
...
| [Натренованість](../04/28-traits.md#Натренованість)                     |   1/2/3   | +5 до перевірок СОМ за рівень.                                                        |
| [Покращена імунна система](../04/28-traits.md#Покращена-імунна-система) |    1/2    | +10 до спротиву хімікатам, хворобам, препаратам і токсинам. Тільки для біоморфів.     |
| [Природний імунітет](../04/28-traits.md#Природний-імунітет)             |     1     | Імунітет до одного конкретного препарата, хіміката чи токсина. Лише для біоморфів.    |
...
Ви маєте вроджений дар до лінгвістичних структур і синтаксису. Отримуєте модифікатор +10 до перевірок ІНТ за рівень, щоб розуміти загальне значення або суть повідомлень, вимовлених на мовах, які ви не знаєте – навіть чужинських. Ця риса не дає бонусів щодо письмових текстів або невербальних повідомлень (таких як спори Посередників).
...
Ця риса доступна лише для персонажів з рисою Псі. Ваш штам Ваттса-МакЛеода є ревнивим і агресивно опирається вашому зараженню іншими екссургентними штамами. Ви отримуєте модифікатор +10 до спротиву зараженню екссургентним вірусом. Збільшіть це до +20, якщо ваш Рівень зараження 33 або більше, +30 якщо 66 або більше.
...
Ця риса доступна лише для біоморфів. Ваша імунна система – міцна. Додайте +10 за рівень до спротиву хімікатам, хворобам, препаратам і токсинам.

### Природний імунітет

**Риса ▼ морфа • Ціна в ОМ: 1**

Ця риса доступна лише для біоморфів. Ваша імунна система має природний імунітет до одного конкретного препарата, хіміката або токсина. Коли ви зазнаєте впливу цього конкретного хіміката, отрути чи патогену, це на вас не впливає. Обговоріть це з майстром, щоб вибрати доречного агента; цей імунітет не можна застосовувати до нанопрепаратів чи нанотоксинів.
...
Ви заражені штамом Ваттса-Маклауда екссургентного віруса, який змінив структуру вашого мозку та покращив мисленнєві здібності. Ви можете вивчити [навичку Псі](../04/19-active-skill-list.md#Псі) та придбати псі-здібності, які називаються [фокусами](../14/06-psi-sleight-summaries.md). На рівні 1 ви можете використовувати лише фокуси псі-чі. На рівні 2 персонаж може використовувати фокуси як псі-чі, так і псі-гамма.
...
| [Слабка імунна система](../04/28-traits.md#Слабка-імунна-система)     |   1/2    | -10 за рівень до опору хімікатам, хворобам, препаратам і токсинам. Лише для біоморфів.                                                   |
...
Ви страждаєте від певного неврологічного розладу, який ще не можна вилікувати. Цей розлад є частиною вашого его і залишається навіть після перевбирання. Він може бути спадковим, бути наслідком погано зробленого морфа чи імпланта, або ж зараження нановірусом під час Падіння. Порадьтеся з ігровим майстром, щоб визначити певний розлад, який підходить для вашої гри. Майстер може накладати модифікатори ослаблення (зазвичай -10) відповідно до розладу. Деякі можливі варіанти:
...
Ваша поведінка вбо настрій змінені. Це може бути пов'язано з обробкою та перепрограмуванням шляхом [психохірургії](../15/05-psychosurgery.md) з прискоренням часу, препаратами, генетичними модифікаціями, псі, або іншими чинниками. Це може бути свідомим вибором, або ж може бути накладено проти вашої волі. Порадьтеся з ігровим майстром, щоб визначити конкретну емоцію (наприклад, сум, тривожність, гнів, стриманість) чи поведінку (наприклад, агресія, крадіжка, харчування, брехня, вживання певного препарату). Застосовуйте модифікатор -10 за рівень до всіх дій, коли поведінки чи емоції не вдалось уникнути.
...
Ця риса доступна лише для біоморфів. Імунна система такого морфа легко ослаблюється. Застосовуйте модифікатор -10 за рівень при опорі ефектам хвороб, препаратів, хімікатів і токсинів.
