...
- **IndEx**: Біржа обміну контрактами для торгівлі кріпацькими контрактами.
...
- **Брамоходець**: Мандрівник, що подорожує через браму Пандори.
...
- **Вартові**: Чергові агенти Вогнемуру.
...
- **Вихід**: Евакуація Землі під час Краху.
- **Вогнемур**: Програмне забезпечення, що захищає систему від вторгнення.
- **Вогнемур**: Таємна міжфракційна змова, що працює над захистом транслюдства від ексризиків.
...
- **ДК**: До Краху (використовується для датування).
...
- **Екссургентний вірус**: Багатовекторний вірус, що поширювався під час Краху, який видозмінює своїх жертв і підкорює їхні розуми.
...
- **Заступники**: Члени внутрішньої системи Вогнемуру.
...
- **Злам-василіск**: Сенсорні дані, що призначене для виклику збоїв та несправностей у мозку; призводить до судом і ще гірших наслідків.
...
- **Інфобіженець**: Біженець, що пережив Крах у вигляді безтілесного інфоморфа.
...
- **КЗ зв'язок**: Квантово-зв'язаний ШЗС зв'язок.
...
- **Комісіонери**: Вид розвинених слизових грибів, єдині живі розумні істоти, з якими транслюдство вже зустрілося.
- **Консерватори**: Фракція Вогнемуру, що протистоїть використанню ШЗІ, асинхронів і чужинських і ТІТАНських технологій.
...
- **Крах**: Війна з ТІТАНами, яка спустошила Землю та майже винищила транслюдство.
...
- **Око**: Внутрішня соціальна мережа та мережа обміну даними у Вогнемурі.
...
- **Осередок**: Таємна група вартових Вогнемуру.
...
- **ПК**: Після Краху (використовується для датування).
...
- **Поселення Фішера**: Варіант поселення-циліндра, що використовує незалежні модулі.
- **ППЗ**: Проєкт повернення Землі повертачів.
- **Прагматики**: Фракція Вогнемуру, яка вірить, що для зупинки ексризиків необхідно робити що завгодно, що потрібно.
...
- **Прометейці**: Група дружніх ШСІ, що допомагають битися з ТІТАНами та підтримують Вогнемур.
...
- **Резервісти**: Фракція Вогнемуру, що готує схованки, бункери та ресурси на випадок ще якогось вимирання людства.
- **Резервна копія**: Збережена копія его, неактивний цифровий розум.
- **Ренегати**: Фракція Вогнемуру, якій поїбати.
...
- **Структуралісти**: Фракція Вогнемуру, що прагне більш формальної організації та виходу на публіку.
...
- **ТІТАНи**: Тотальні інформаційні тактичні автомати нагляду. ШСІ, що атакували транслюдство та спричинили Крах.
...
- **Фільтр**: Заступник, що займається соціальною інженерією, маніпуляцією ЗМІ та прикриттям.
- **Фокус**: Псі-сила.
...
- **Циліндр О'Нейла**: Циліндричне поселення в формі банки газованої води, що обертається для створення гравітації.
