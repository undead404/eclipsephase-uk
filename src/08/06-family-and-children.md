...
Після великих розкопок і відновлення "видалених" даних Cognite, ми нарешті маємо досить точне уявлення про дослідження, що стоїть за Проєктом Футура (чиї вцілілі суб'єкти відомі у народі як "Загублені" завдяки сенсаційним ЗМІ) та його потенційній застосовності для військових справ Ультиматів.
